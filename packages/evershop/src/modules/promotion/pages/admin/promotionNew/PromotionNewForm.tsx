...
export default function PromotionNewForm({ action, gridUrl }: PromotionNewFormProps) {
  return (
    <Form method="POST" action={action} submitBtn={false} id="promotionNewForm">
      ...
      <FormButtons cancelUrl={gridUrl} formId="promotionNewForm" />
    </Form>
  );
}
